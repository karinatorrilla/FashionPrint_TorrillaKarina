...
const openBurgerNav = () => {
		 document.getElementById("header_burger_menu").style.display = "inline-block";
	};
	return (
		<>
			<nav className="navbar is-dark" role="navigation" aria-label="main navigation">
			  <div className="navbar-brand">
			  		<a role="button" className="navbar-burger" aria-label="menu" aria-expanded="false"  href="/" id="menu_burger_padre" onClick={openBurgerNav}>
			  	...
			  	<div className="lado_izquierdo">
			  		<figure className="logo_img">
			   		...
			   		<div className="navbar-end">
			   			...
			   			<a className="navbar-item is-active" href="/" id="menu_padre_producto" >
			   			Productos
